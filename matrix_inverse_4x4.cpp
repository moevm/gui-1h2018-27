    ...
    ui(new Ui::matrix_inverse_4x4)
{
    ...
    ui->pushButton_inverse_4x4->setDefault(true);//принажатии кнопки enter, будет нажиматься ok
...
void matrix_inverse_4x4::getMatrixWithoutRowAndCol(double **matrix, int size, int row, int col, double **newMatrix)
{
...
double matrix_inverse_4x4::matrixDet(double **matrix, int size)
{
    double det = 0;
    int degree = 1;
...
double **matrix_inverse_4x4::InverseMatrix(double **a, double **b, bool &error, int size)
{
    double chast = 0;
    double mnoj = 0;
...
void matrix_inverse_4x4::on_pushButton_inverse_4x4_clicked()
{
    ...
    if (error == true) {
        ...
        ui->label_inverse_4x4_res_1->setText(QString::number(res[0][0]));
        ui->label_inverse_4x4_res_2->setText(QString::number(res[0][1]));
        ui->label_inverse_4x4_res_3->setText(QString::number(res[0][2]));
        ui->label_inverse_4x4_res_4->setText(QString::number(res[0][3]));

        ui->label_inverse_4x4_res_5->setText(QString::number(res[1][0]));
        ui->label_inverse_4x4_res_6->setText(QString::number(res[1][1]));
        ui->label_inverse_4x4_res_7->setText(QString::number(res[1][2]));
        ui->label_inverse_4x4_res_8->setText(QString::number(res[1][3]));

        ui->label_inverse_4x4_res_9->setText(QString::number(res[2][0]));
        ui->label_inverse_4x4_res_10->setText(QString::number(res[2][1]));
        ui->label_inverse_4x4_res_11->setText(QString::number(res[2][2]));
        ui->label_inverse_4x4_res_12->setText(QString::number(res[2][3]));

        ui->label_inverse_4x4_res_13->setText(QString::number(res[0][0]));
        ui->label_inverse_4x4_res_14->setText(QString::number(res[0][1]));
        ui->label_inverse_4x4_res_15->setText(QString::number(res[0][2]));
        ui->label_inverse_4x4_res_16->setText(QString::number(res[0][3]));
